...
LaraGram Prompts is perfect for accepting user input in your [Commander console commands](/v3/commander#writing-commands), but it may also be used in any command-line PHP project.
...
Alternatively, you may leverage the power of LaraGram's [validator](/v3/validation). To do so, provide an array containing the name of the attribute and the desired validation rules to the `validate` argument:
