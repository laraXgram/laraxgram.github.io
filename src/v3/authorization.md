...
> [!NOTE]
> All policies are resolved via the LaraGram [service container](/v3/container), allowing you to type-hint any needed dependencies in the policy's constructor to have them automatically injected.
