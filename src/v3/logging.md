...
You may write information to the logs using the `Log` [facade](/v3/facades). As previously mentioned, the logger provides the eight logging levels defined in the [RFC 5424 specification](https://tools.ietf.org/html/rfc5424): **emergency**, **alert**, **critical**, **error**, **warning**, **notice**, **info** and **debug**:
...
> [!NOTE]
> If you need to share log context while processing queued jobs, you may utilize [job middleware](/v3/queues#job-middleware).
...
> [!NOTE]
> All of your "tap" classes are resolved by the [service container](/v3/container), so any constructor dependencies they require will automatically be injected.
