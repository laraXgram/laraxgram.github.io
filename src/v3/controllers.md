...
> [!NOTE]
> Controller stubs may be customized using [stub publishing](/v3/commander#stub-customization).

<a name="controller-middleware"></a>
## Controller Middleware

[Middleware](/v3/middleware) may be assigned to the controller's listens in your listen files:
...
The LaraGram [service container](/v3/container) is used to resolve all LaraGram controllers. As a result, you are able to type-hint any dependencies your controller may need in its constructor. The declared dependencies will automatically be resolved and injected into the controller instance:
