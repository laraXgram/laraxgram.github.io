...
> [!WARNING]
> If you customize the pluralizer's language, you should explicitly define your Eloquent model's [table names](/src/eloquent.mdt.md#table-names).
...
If you are using the [Temple8 templating engine](/src/temple8.md8.md), you may use the `{{ }}` echo syntax to display the translation string:
