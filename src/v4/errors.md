...
In LaraGram, exception reporting is used to log exceptions. By default, exceptions will be logged based on your [logging](/v4/logging) configuration. However, you are free to log exceptions however you wish.
...
> [!NOTE]
> To customize the exception reporting for a given exception, you may also utilize [reportable exceptions](/v4/errors#renderable-exceptions).
...
When messages are written to your application's [logs](/v4/logging), the messages are written at a specified [log level](/v4/logging#log-levels), which indicates the severity or importance of the message being logged.
...
> [!NOTE]
> You may type-hint any required dependencies of the `report` method and they will automatically be injected into the method by LaraGram's [service container](/v4/container).
