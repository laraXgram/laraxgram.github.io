...
First, let's setup a channel listener using the `subscribe` method. We'll place this method call within an [Commander command](/commander) since calling the `subscribe` method begins a long-running process:
